...
public class InfoGrupo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_info_grupo, container, false);

        Bundle b = getArguments();
        String grupo = b.getString("grupo");
        getActivity().setTitle(grupo);

        conexion = new Conexion(getActivity());
        getProductos(grupo);

        Toast.makeText(getActivity(), items.size() + " Productos Encontrados", Toast.LENGTH_SHORT).show();
        ...
        adapter.setOnProductoListener(new OnProductoListener() {
            ...
            public void onFondoClicked(int position) {
                ...
                fragmentTransaction.replace(R.id.frame, productoFragment, "infoGrupo_fragment");*/
                FragmentManager fragmentManager = getFragmentManager();
                fragmentManager.beginTransaction()
                        .replace(R.id.frame, productoFragment, "infoGrupo_fragment").addToBackStack(null)
                        .commit();
    ...
    public List<Producto> getProductos(String grupo)
    {
        Cursor c = conexion.getProductos(grupo);
        items = new ArrayList<>();
        if(c.moveToFirst())
        {
            do {
