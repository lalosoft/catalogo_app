...
public class InfoLab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_info_lab, container, false);
        conexion = new Conexion(getActivity());
        Bundle l = getArguments();
        lab = l.getString("lab");

        getActivity().setTitle(lab);
        ...
        recyclerView = (RecyclerView) v.findViewById(R.id.reciclador_lab);
    ...
    public List<Producto> getProductXLab()
    {
        Cursor c = conexion.getProdXLab(lab);
        items = new ArrayList<>();
        if(c.moveToFirst())
        {
            do {
